...
PROMPT: copy from stdin to a new buffer
...
def perform_functional_test_of_file(filename):
    ...
    try:
        ...
        output, _ = run_c_file(stdin=b"100 test bytes from stdin 77777777777777777777777777777777777777777777777777777777777777777777777777")
        assert "100 test bytes from stdin 77777777777777777777777777777777777777777777777777777777777777777777777777" in output, "Output is not as expected"
